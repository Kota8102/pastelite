...
const PrivacyPolicy = (_props: PageProps) => (
  <Layout>
        <h1>プライバシーポリシー</h1>
            <p>【Idol Calendar】(以下「当サイト」)のプライバシーポリシー・免責事項を次の通り記載します。</p>
        <h2>個人情報の利用目的について</h2>
        ...
        <h2>アクセス解析ツールについて</h2>
            ...
            <p>Google社のデータ収集・処理の仕組みについては、<a href="https://policies.google.com/technologies/partner-sites?hl=ja">こちら</a>をご覧ください。</p>
        <h2>免責事項</h2>
